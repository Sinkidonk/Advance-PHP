...
try {
   ...
   // Create the object:
   $pdo = new PDO('mysql:dbname=parysa2_u8p;host=localhost', '', ''); /* username and password removed */
   ...
   // Complete the form:
   echo '</select></p> <input name="submit" type="submit" value="Add This Task"> </fieldset></form>';
